"""
Код взят из решения к заданию 5.1 занятия "Три кита ООП(ч.1)"
Добавлены декораторы к геттерам и сеттерам.
Вызовы соответствующих методов изменены -- теперь используется формат,
предоставленный декораторами.
"""
